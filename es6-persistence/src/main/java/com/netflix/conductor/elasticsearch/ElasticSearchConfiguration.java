...
public interface ElasticSearchConfiguration extends Configuration {
    ...
    String ELASTIC_SEARCH_READ_INDEX_NAME_PROPERTY_NAME = "workflow.elasticsearch.read.index.name";
    String ELASTIC_SEARCH_READ_INDEX_NAME_DEFAULT_VALUE = "conductor";

    String ELASTIC_SEARCH_WRITE_INDEX_NAME_PROPERTY_NAME = "workflow.elasticsearch.write.index.name";
    String ELASTIC_SEARCH_WRITE_INDEX_NAME_DEFAULT_VALUE = "conductor";
    ...
    default String getReadIndexName() {
        return getProperty(ELASTIC_SEARCH_READ_INDEX_NAME_PROPERTY_NAME, ELASTIC_SEARCH_READ_INDEX_NAME_DEFAULT_VALUE);
    }

    default String getWriteIndexName() {
        return getProperty(ELASTIC_SEARCH_WRITE_INDEX_NAME_PROPERTY_NAME, ELASTIC_SEARCH_WRITE_INDEX_NAME_DEFAULT_VALUE);
    }
